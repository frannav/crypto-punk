...
contract CryptoPunk is ERC721, ERC721Enumerable, PunkDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("CryptoPunk", "PLPKS") {
        maxSupply = _maxSupply;
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current < maxSupply, "There are no CryptoPunk left :(");
